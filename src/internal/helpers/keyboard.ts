/**
 * Credits: https://github.com/melt-ui/melt-ui/blob/develop/src/lib/internal/helpers/keyboard.ts
...
export const FIRST_KEYS = [kbd.PAGE_UP, kbd.HOME];
// export const FIRST_KEYS = [kbd.ARROW_DOWN, kbd.PAGE_UP, kbd.HOME];
// export const LAST_KEYS = [kbd.ARROW_UP, kbd.PAGE_DOWN, kbd.END];
export const LAST_KEYS = [kbd.PAGE_DOWN, kbd.END];
